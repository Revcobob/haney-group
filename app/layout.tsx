  ...
  const body = (
    <html lang="en">
      <head>
        ...
        />
        {/* Tag <html> as JS-capable immediately so the data-reveal CSS
            switches into hide-then-fade-in mode. Without this, content is
            visible by default — fine fallback if JS ever fails. */}
        <script
